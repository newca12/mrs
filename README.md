...
> ⚠️ **CRITICAL WARNING**: Version 0.2.0 contains critical bugs (including Skolem symbol compliance issues and proof verification gaps under AVATAR) that are fully resolved in **v0.2.2**. Please use **v0.2.2** for any stable deployments or evaluations.
