...
maximum_score = 150
expected_score = 148
expected_verified_good = 60
expected_verified_bad = 39
expected_unknown = 1
expected_false_rejection = 0
...
evaluation_command = "nix develop -c cargo run --release -p mrs-bench --bin score_proover2026 -- crates/mrs-bench/proover-corpus/Proover2026 --competition --proover target/release/mrs-proover --time 10 --workers 8 --output reports/proover-2026.tsv"
"#;
