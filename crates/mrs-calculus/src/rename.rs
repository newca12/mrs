...
fn rename_literal_id(
    lit: &mrs_core::term_bank::IdLiteral,
    offset: VarId,
    bank: &mut mrs_core::term_bank::TermBank,
...
fn rename_atom_id(
    atom: &mrs_core::term_bank::IdAtom,
    offset: VarId,
    bank: &mut mrs_core::term_bank::TermBank,
) -> mrs_core::term_bank::IdAtom {
    match atom {
        ...
        mrs_core::term_bank::IdAtom::Eq(l, r) => mrs_core::term_bank::IdAtom::Eq(
            rename_term_id(*l, offset, bank),
            rename_term_id(*r, offset, bank),
        ),
    }
}
