...
### 1. AC-Equivalence Matching in `axiom_leaf.rs` — **+1 per valid proof**
...
### 2. Recursive / Cyclic Definition Chain Detection — **prevent −10**
...
### 3. E-prover Skolemization Variable Leakage — **prevent −10**
...
### 4. Stronger Structural Coverage → More `+2` Points
...
### 5. Performance: Avoid Re-parsing the Problem File Per Step
...
| Benchmark against Nörgler | After AC-equiv fix | ❌ TODO |
