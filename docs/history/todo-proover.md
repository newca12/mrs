...
> Status: Superseded task ledger. Current verifier behavior is documented in
> [`reference/trust-and-verification.md`](../reference/trust-and-verification.md)
> and [`guides/proover.md`](../guides/proover.md).
...
See `reports/proover/harness-history.md` §6 for the full table.
