...
> Status: Historical append-only log. It contains runs from multiple commits,
> machines, and branches. Do not use its tables as the current baseline.
...
commit adb7f758cc7209ec4749624f5e439f58be3417db

[root@server01 mrs]# crates/mrs-bench/run_strategy_sweep.sh --edition casc-30 --divisions eps --casc-times --jobs 8 --output crates/mrs-bench/results/casc-30-sweep-eps-$(date +%Y%m%d)

commit b214a13d34bfc3f2e2f901141d51c5974da4d25d

[PPROD:user@server97:/DATA/ai/user/mrs]$ MRS_WORKERS=8 crates/mrs-bench/casc.sh   --edition casc-j13 --systems mrs --divisions ueq,fne   --casc-times   --jobs 2   --output crates/mrs-bench/results/casc-j13-ueq-fne-$(date +%Y%m%d)

[www@user99 mrs]$ MRS_WORKERS=8 crates/mrs-bench/casc.sh   --edition casc-30   --systems mrs --divisions ueq,fne   --casc-times   --jobs 2   --output crates/mrs-bench/results/casc-30-ueq-fne-$(date +%Y%m%d)

[root@mtsdev04 mrs]# crates/mrs-bench/run_strategy_sweep.sh --edition casc-30 --divisions feq --casc-times --jobs 8 --output crates/mrs-bench/results/casc-30-sweep-feq-$(date +%Y%m%d)



commit 2c5a5c269bffcae91cf9ca93a7831584fe4e467c

[done] still total 2
[root@mtsdev01 mrs]# crates/mrs-bench/run_strategy_sweep.sh --edition casc-30 --divisions eps --casc-times --jobs 8 --output crates/mrs-bench/results/casc-30-sweep-eps-$(date +%Y%m%d)

commit b6de686efaaf607c537fbf7fb75f785e7cd22923

[done]
[root@server04 mrs]# crates/mrs-bench/run_strategy_sweep.sh --edition casc-j13 --divisions fne --casc-times --jobs 8 --output crates/mrs-bench/results/casc-j13-sweep-fne-$(date +%Y%m%d)

[done] total ok 2 miscompiled or issue
[root@server01 mrs]# crates/mrs-bench/run_strategy_sweep.sh --edition casc-30 --divisions eps --casc-times --jobs 8 --output crates/mrs-bench/results/casc-30-sweep-eps-$(date +%Y%m%d)




commit 04db4a44b8073dd43c1a4b7f7e45ccb3381e74c1 (HEAD -> main, origin/main, origin/HEAD)

[done]
[PPROD:user@server97:/DATA/ai/user/mrs]$ MRS_WORKERS=8 crates/mrs-bench/casc.sh --edition casc-30 --systems mrs --divisions ueq  --casc-times --jobs 2 --output crates/mrs-bench/results/casc-30-W8J2-ueq-$(date +%Y%m%d)
crates/mrs-bench/results/casc-30-W8J2-ueq-20260924/run.csv
Running `target/debug/bench_report crates/mrs-bench/results/casc-30-W8J2-ueq-20260924/run.csv`
CASC-30 Results — 2026-09-24 16:12  (300 problems × 1 systems)
==============================================================
...
[done]
[www@server99 mrs]$ MRS_WORKERS=8 crates/mrs-bench/casc.sh --edition casc-30 --systems mrs --divisions eps  --casc-times --jobs 2 --output crates/mrs-bench/results/casc-30-W8J2-eps-$(date +%Y%m%d)
Running `target/debug/bench_report crates/mrs-bench/results/casc-30-W8J2-eps-20260924/run.csv`
CASC-30 Results — 2026-09-24 09:35  (100 problems × 1 systems)
==============================================================
...
[done]
[root@mtsdev01 mrs]# crates/mrs-bench/run_strategy_sweep.sh --edition casc-30 --divisions fne --casc-times --jobs 8 --output crates/mrs-bench/results/casc-30-sweep-fne-$(date +%Y%m%d)

commit 01754afd248a72534b90f2bc1a5ec9ccf649cf5b

[done]
[root@server04 mrs]# crates/mrs-bench/run_strategy_sweep.sh --edition casc-30 --divisions eps --casc-times --jobs 8 --output crates/mrs-bench/results/casc-30-sweep-$(date +%Y%m%d)

[done]
[root@server01 mrs]# crates/mrs-bench/run_strategy_sweep.sh --edition casc-30 --divisions epu --casc-times --jobs 8 --output crates/mrs-bench/results/casc-30-sweep-$(date +%Y%m%d)

[PPROD:user@server97:/DATA/ai/user/mrs]$ crates/mrs-bench/run_strategy_sweep.sh --edition casc-j13 --divisions ueq --casc-times --jobs 16 --output crates/mrs-bench/results/casc-j13-sweep-ueq-$(date +%Y%m%d)

[www@server99 mrs]$ crates/mrs-bench/run_strategy_sweep.sh --edition casc-30 --divisions ueq --casc-times --jobs 16 --output crates/mrs-bench/results/casc-30-sweep-ueq-$(date +%Y%m%d)


commit 0f69b2209111cc3c1804f0cdcd3d3bacf5bdc49c (HEAD -> main, origin/main, origin/HEAD)
...
Running `target/debug/bench_report crates/mrs-bench/results/casc-j13-W8J2-nosharing-20260923/run.csv`
CASC-J13 Results — 2026-09-24 06:31  (800 problems × 1 systems)
===============================================================
...
[ongoing]
[www@server99 mrs]$ cargo run --release -p mrs-bench --bin audit_casc_proofs -- --run crates/mrs-bench/results/casc-j13-W8J2-nosharing-20260923 --problems-dir crates/mrs-bench/problems/casc-j13 --checks stric
t,mrs,ladder --strict-time 60 --mrs-time 60 --ladder-time 60 --ladder-workers 8 --jobs 4 --output crates/mrs-bench/results/casc-j13-W8J2-nosharing-20260923/proof-audit
...
[www@server99 mrs]$ ./crates/mrs-bench/remote-cert-campaign.sh all > remote-cert-campaign.out 2> remote-cert-campaign.err
 /DATA/ai/mrs/crates/mrs-bench/results/remote-cert
...
Running `target/debug/bench_report crates/mrs-bench/results/casc-30-W8J2-noshare-20260922/run.csv`
CASC-30 Results — 2026-09-24 06:35  (1101 problems × 1 systems)
===============================================================
...
Running `target/debug/bench_report crates/mrs-bench/results/casc-j13-feq-sharing-2000-20260922_092643/run.csv`
CASC-J13 Results — 2026-09-23 06:48  (300 problems × 1 systems)
===============================================================
Division  Problems    mrs
                 Solved  Avg (s)
------------------  --------------------
...
Running `target/debug/bench_report crates/mrs-bench/results/casc30-feq-sharing2000-W8J1-20260922/run.csv`
CASC-30 Results — 2026-09-23 06:45  (400 problems × 1 systems)
==============================================================
...
Running `target/debug/bench_report /DATA/ai/user/mrs/crates/mrs-bench/results/casc-30-W8J2-20260921/run.csv`
...
[done]
[PPROD:user@server97:/DATA/ai/user/mrs]$ MRS_WORKERS=8 crates/mrs-bench/cooperative_portfolio_sweep.sh casc-j13 feq 11,12,8,6,5,7,1,4 240 1 crates/mrs-bench/results/coop-cascj13-feq-candidate
