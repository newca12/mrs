...
> Status: Dated benchmark report. The source-derived schedule registry is in
> [`reference/schedules.md`](../../reference/schedules.md); this report retains
> the evidence and caveats for the 2026-09 analysis.
