...
- [`architecture-review-2026-09-03.md`](../history/architecture-review-2026-09-03.md),
  which records architectural opportunities and their implementation history.
- [`auto-proof-review-2026-09.md`](../reports/proover/auto-proof-review-2026-09.md), which documents proof
  recording and independent verification.
- [`soundness-status-historical.md`](../reports/audits/soundness-status-historical.md), which records audit results.
- [`audit-2026-06.md`](../reports/audits/audit-2026-06.md), which records benchmark methodology and failure
  analysis.
- [`trust-and-verification.md`](../reference/trust-and-verification.md), which defines verifier behavior.
